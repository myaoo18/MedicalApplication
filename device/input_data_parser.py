...
with open ('../device/logs/input_data_parser.log', 'r+') as f:
    f.truncate(0)
logging.basicConfig(filename='../device/logs/input_data_parser.log', level=logging.DEBUG, format='%(asctime)s %(levelname)s %(name)s %(message)s')
